  ...
  return (
    <div className="flex flex-col justify-center items-center w-full xl:w-3/5">
        ...
        <p className="text-xl text-gray-400 mb-4 sm:text-3xl">
            ...
            dedicado y motivado por crear contenido que divierta a la comunidad.
        </p>
        <p className="text-xl text-gray-400 sm:text-3xl">
            He trabajado con diferentes streamers que puedes ver a 
            <span className="text-red-600"> continuacion.</span> 
        </p>
    </div>
  )
}
